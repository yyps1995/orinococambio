...
try {
  $stmt = $user_home->runQuery("SELECT * FROM ventas WHERE usuario=:uid ORDER BY STR_TO_DATE(solicitud,'%d-%m-%Y') DESC");
  $stmt->execute(array(":uid"=>$_SESSION['userSession']));
...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
    ...
    <div id="area">
          ...
          <center id="up"><h2>Transacciones</h2></center>
           <div class="contenedor-transacciones">
            <table >
                <thead>
                    <tr>
                        <td class="title"><h6>Solicitud</h6></td>
                        <td class="title"><h6>Hora de la solicitud</h6></td>
                        <td class="title"><h6>Pago</h6></td>
                        <td class="title"><h6>Memo</h6></td>
                        <td class="title"><h6>De</h6></td>
                        <td class="title"><h6>A</h6></td>
                        <td class="title"><h6>Vendido</h6></td>
                        <td class="title"><h6>Tasa</h6></td>
                        <td class="title"><h6>Recibido</h6></td>
                        <td class="title"><h6>Banco</h6></td>
                        <td class="title"><h6>Estatus</h6></td>
                ...
                ?>
                    <tr>
                        ...
                        <td class="jj"><?php echo $row['moneda'];?></td>
                         <td class="jj"><?php echo $row['cambio'];?></td>
                        <td class="jj"><?php echo $row['cantidad'];?></td>
                        <td class="jj"><?php echo $row['tasa'];?></td>
                        <td class="jj"><?php echo $row['bolivares'];?></td>
                        
                        <?php

                        try {
                            $stmt = $user_home->runQuery("SELECT * FROM banco WHERE bancoID=:bank");
        ...
        <a href="" style="color: grey;">Regresar al Inicio</a>
        </div>
        </div>
    </div>
