  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
    ...
    <div class="col-sm-12 col-md-12 col-lg-9 col-center">
          <a class="navbar-brand" href=""><img class="img-responsive colibri" src="img/LOGO_PRUEBA.png"></a>
           ...
           <div id="area"> 
           <div class="animated fadeInDownBig col-md-12 col-lg-12 col-center ">
              

                <div class="contenedor-dbanco">
                  <center ><h2>Datos bancarios/monedero</h2></center>
              <form action="bancodetalles.php" method="post">
                <div id="scroll-banco">
            <table class="">
                <thead>
                    <tr>
                        <th class="title"><h6>Titular/Nombre</h6></th>
                        <th class="title"><h6>Banco/Exchanger</h6></th>
                        <th class="title"><h6>Cuenta/BTH/ETH</h6></th>
                        <th class="title"><h6>Cédula</h6></th>
                        <th class="title"><h6>Número/Direccion del monedero</h6></th>
                         <th class="title"><h6>Correo</h6></th>
                        <th class="title"><h6>Consultar</h6></th>
                ...
                ?>
                    <tr>
                        ...
                        <td class="jj"><?php echo $row['nombre']; ?></td>
                        <td class="jj"><?php echo $row['banco'];?></td>
                        <td class="jj"><?php echo $row['bancotipo'];?></td>
                         <td class="jj"><?php echo $row['denominacion'].$row['cedula'];?></td>
                        <td class="jj"><?php echo $row['nrocuenta'];?></td>
                         <td class="jj"><?php echo $row['user_email'];?></td>
                        <td class="jj kk"><input type="radio" name="banco" value="<?php echo $row['bancoID'];?>" required></td>
          ...
          <center>
              <a href="verificacion_banco.php"><button style="margin: 5px;" type="button" class="btn btn-large botonuser">Agregar nueva cuenta/monedero</button></a>
              <button type="submit" class="btn btn-large botonuser" id="consult">Consultar</button>
          </center>
           </form> 
          </div>
        </div>
