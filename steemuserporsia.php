                ...
                <div class="form-group " id="se">
                    <div><br>
                     <label id="regular">@</label>
                      <input type="text" name="username" class="middled form-control" placeholder="Introduce tu usuario de steem" id="steemuser" required>
                      <button type="submit" class="btn btn-large continuaropcion" >Continuar</button>
              ...
              <form id="venta2" style="display:none">
                ...
                <div class="form-group " id="se">
                    <div><br>
                      <center>
                      <label id="regular">@</label>
                      <input type="text" name="username" class="middled2 form-control" placeholder="Introduce tu usuario de steem" id="steemuser" required>
                      <button type="submit" class="btn btn-large continuaropcion" id="myBtnsteemit">Continuar</button>
                      <input type="hidden" name="de" value="<?php echo $de; ?> ">
                      <input type="hidden" name="a" value="<?php echo $a; ?> ">
                      <input type="hidden" name="sdb" value="<?php echo $sdb; ?> ">
                      <input type="hidden" name="vef" value="<?php echo $vef; ?> ">
