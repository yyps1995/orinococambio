  ...
  echo'<div class="content-wrapper">
    ...
    <div id="area">
           ...
           <div id="contenedor-detalles">
              ...
              <tbody >
              	<tr>
              		<center><h2 class="eliminada">'.$roly["nombre"].'&nbsp;'.$roly["apellido"].'</h2>('.$roly["telefono"].')</center><br>
              	</tr>
                  ...
                  <tr>
                    ...
                    <th class="title" scope="row"><h6>Eliminada:</h6></th>
                    <td>'.$row["pago"].'</td>
                  ...
                  <tr>
                    ...
                    <th class="title" scope="row"><h6>Titular:</h6></th>
                    <td >'.$roll["nombre"].'</td>
                  ...
                  <tr> 
                    ...
                    <th class="title" scope="row"><h6>Recibir:</h6></th>
                    <td class="eliminada"> '.$row["cantidad"].'&nbsp;'.$row["moneda"].'</td>  
                  ...
                  <tr> 
                    ...
                    <div id="transfer">
                    	<h4 class="al">Transferir:</h4>
                   		<h4 class="al eliminada">'.$row["bolivares"].'&nbsp;'.$row["cambio"].'</h4><br>
                    </div> 
                    <div id="trans">	
