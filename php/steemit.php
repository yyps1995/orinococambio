  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <br><br><br><br><br><br>
        <div class="animated fadeInLeftBig col-md-12 col-lg-6 col-center">
          <div class="contenedor11">
           <div class="col-center">
          <br><br><br>
                <div class="form-group " id="steemitdatos">
                      <div class="datos">
                       <h5>Transfiere <strong><?php echo $sdb;?> <?php echo $de;?>
                       </strong> a <strong>@orinoco</strong></h5>
                       <h5>Copia este memo: <strong><?php echo $memo ;?></strong></h5>
                       <a href="https://steemit.com/@<?php echo $username ;?>/transfers" target="_blank"><button type="submit" class="btn btn-large botoniniciar" >Ir a steemit</button></a>
                      </div>
                    </div>
                    <br><br>
                </div>
