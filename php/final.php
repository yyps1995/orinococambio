...
if($a == "1"){
	...
	if($from == "SBD"){
		...
		echo "https://steemconnect.com/sign/transfer?from=".$username."&to=orinoco&amount=".$sdb."%20SBD&memo=".$memo."&redirect_uri=https%3A%2F%2Forinococambio.com/confirm.php";
	}
	else if($from == "STEEM"){
		echo "https://steemconnect.com/sign/transfer?from=".$username."&to=orinoco&amount=".$sdb."%20STEEM&memo=".$memo."&redirect_uri=https%3A%2F%2Forinococambio.com/confirm.php";
	}
